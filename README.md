...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/earthrainbow/V2Ray_ws-tls_bash_onekey/with_cfwarp/install.sh" && chmod +x install.sh && bash install.sh
```
